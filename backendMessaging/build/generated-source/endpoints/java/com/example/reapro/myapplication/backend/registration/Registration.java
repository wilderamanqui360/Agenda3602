 ...
 * on 2015-05-31 at 05:52:24 UTC 
 * Modify at your own risk.
 */

package com.example.reapro.myapplication.backend.registration;
...
public class Registration extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class ListDevices extends RegistrationRequest<com.example.reapro.myapplication.backend.registration.model.CollectionResponseRegistrationRecord> {
    ...
    protected ListDevices(java.lang.Integer count) {
      super(Registration.this, "GET", REST_PATH, null, com.example.reapro.myapplication.backend.registration.model.CollectionResponseRegistrationRecord.class);
    ...
    @com.google.api.client.util.Key
    private java.lang.String idFamiliar;

    /**

     */
    public java.lang.String getIdFamiliar() {
      return idFamiliar;
    }

    public ListDevices setIdFamiliar(java.lang.String idFamiliar) {
   ...
   * @return the request
   */
  public Register register(java.lang.String regId, java.lang.String familiar) throws java.io.IOException {
    Register result = new Register(regId, familiar);
    initialize(result);
    return result;
  }
  ...
  public class Register extends RegistrationRequest<Void> {
    ...
    private static final String REST_PATH = "registerDevice/{regId}/{familiar}";
     ...
     * @since 1.13
     */
    protected Register(java.lang.String regId, java.lang.String familiar) {
      ...
      this.familiar = com.google.api.client.util.Preconditions.checkNotNull(familiar, "Required parameter familiar must be specified.");
    }
    ...
    public Register setFamiliar(java.lang.String familiar) {
